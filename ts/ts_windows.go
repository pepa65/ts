...
// the origin of the coordinate system (0,0) is at the topleft cell of the buffer:
...
// https://msdn.microsoft.com/en-us/library/windows/desktop/ms686311(v=vs.85).aspx
